...
class BookingService {
    ...
    async reserveSeat(flightId, seatNumber, passengerId, classType) {
        try {
            ...
            return {
                ...
                seat: seatState,
                vectorClock: currentClock,
                message: 'Asiento ' + seatNumber + ' reservado. Tienes 15 minutos para completar la compra.'
            };
    ...
    async refundSeat(flightId, seatNumber, passengerId) {
        try {
            ...
            return {
                ...
                message: 'Devolucion procesada. El asiento estara disponible en 5 minutos por logistica de catering.'
            };
    ...
    async releaseSeatAfterCatering(flightId, seatNumber) {
        try {
            ...
            console.log('[Booking] Asiento ' + seatNumber + ' ahora esta LIBRE despues del timer de catering');
