...
class ItineraryService {
    ...
    async findFlightForSegment(segment) {
        ...
        // 2. Intentar exacto con fechas si existen
        ...
        // 3. Fallback: buscar exacto SIN fechas
            ...
            try {
                await SeatState.findOneAndUpdate(
                    ...
                    },
                    {
                        ...
                        last_updated_by_node: this.bookingService.nodeId
                    },
                    { new: true }
                );

                const reservationKey =
                    'reservation:' + segment.flightId + ':' + segment.seatNumber;
